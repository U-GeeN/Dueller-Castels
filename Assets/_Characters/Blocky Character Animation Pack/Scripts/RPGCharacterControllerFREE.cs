...
public class RPGCharacterControllerFREE : MonoBehaviour{
    ...
    public float inputDashVertical = 0f;
    public float inputDashHorizontal = 0f;
	float inputBlock = 0f;
	bool inputLightHit;
	bool inputDeath;
	bool inputAttackR;
	...
	/// </summary>
	void Inputs(){
		//inputDashHorizontal = Input.GetAxis("DashHorizontal");
		//inputDashVertical = Input.GetAxis("DashVertical");
		inputHorizontal = Input.GetAxis("Horizontal");
		inputVertical = Input.GetAxis("Vertical");
		//inputLightHit = Input.GetButtonDown("LightHit");
		//inputDeath = Input.GetButtonDown("Death");
		//inputAttackL = Input.GetButtonDown("AttackL");
		inputAttackR = Input.GetButtonDown("Fire1");
